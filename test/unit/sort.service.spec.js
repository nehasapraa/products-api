...
describe('Testing Product Sort Functions', () => {
  ...
  const customer1 = {
    customerId: 123,
    products: [cust1_prod1, cust1_prod2, cust1_prod3],
  };
  const customer2 = {
    customerId: 23,
    products: [cust2_prod1, cust2_prod2, cust2_prod3],
  };
  const customer3 = { customerId: 23, products: [cust3_prod1, cust3_prod2] };
  const customer4 = {
    customerId: 23,
    products: [cust4_prod1, cust4_prod2, cust4_prod3],
  };
  ...
  it('should return products sorted by shopping history(recommended)', async () => {
    ...
    let productsArray = await sortService.getPopularProducts(
      customers,
      products
    );
    ...
    productsArray.sort(sortService.dynamicSort(option));
    const recommendedProducts = productService.delete_unwanted_fields(
      productsArray
    );
